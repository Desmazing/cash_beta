...
********************************\n\nAccount ID: {}\nDate: {}\nAmount Withdrawn: {}. {}\nBalance: {}. {:.2f}\n\
********************************".format(currentUserId, date, currency.lower(), moneyToWithdraw, currency.lower(), newBalance))                    
        else:
...
def deposit(userData, currentUserId, currency): 
    ...
    if moneyToDeposit > 0:
        ...
        if answer=='Y':
            print("\nDeposit Successful!\nThank you for choosing BETA BANK\n\
********************************\n\nAccount ID: {}\nDate: {}\nAmount Deposited: {}. {:.2f}\nBalance: {}. {:.2f}\n\
********************************".format(currentUserId, date, currency.lower(), moneyToDeposit, currency.lower(), newBalance)) 
        else:
...
Balance: Ksh. {:.2f}\n".format(currentUserId, date, transferAmount, userData[transferTo]['username'], userData[currentUserId]['balance']['KSH']))
                else:
            ...
            if 0 < transferAmount < d and d > 1 :
                ...
                if answer=='Y':
                    print("\nTransfer Successful!\nThank you for choosing BETA BANK\n\
********************************\n\nAccount ID: {}\nDate: {}\nTransferred ${:.2f} to {}\n\
Balance: ${:.2f}\n".format(currentUserId, date, transferAmount, userData[transferTo]['username'], userData[currentUserId]['balance']['USD']))
                else:
                    print("Transfer Successful! Thank you for choosing BETA BANK.")
